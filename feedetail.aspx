<%@ Page Language="VB" AutoEventWireup="false" CodeFile="feedetail.aspx.vb" Inherits="feedetail" %>
...
<head runat="server">
    <title>Vagbhat - Fee Details</title>
    <style type="text/css">
        .style1
        {
            width: 800;
...
<body>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true" Width="500" HorizontalAlign ="Center"  >
    </asp:GridView>
    <br />
    <div>
